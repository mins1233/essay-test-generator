...
import achievementLevelsMarkdown from "./data/middle-school-science-achievement-levels.md?raw";

export const MIDDLE_SCHOOL_SCIENCE_STANDARDS = parseAchievementLevelMarkdown(achievementLevelsMarkdown);
...
function parseSection(section) {
  const heading = section.match(/^## (\[9과\d{2}-\d{2}\])\s+(.+)$/mu);
